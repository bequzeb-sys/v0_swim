...
export const coaches: Coach[] = [
  {
    ...
    bio: "Ancien nageur de niveau régional, je coach à la Réunion depuis 8 ans. Mon approche combine technique de nage et préparation mentale pour des résultats durables. J'ai accompagné des dizaines de swimmers vers leurs premiers triathlons.",
    yearsExperience: 8,
  ...
  },
  {
    ...
    bio: "Monitrice diplômé et ancienne compétitrice en eau libre, je suis passionnée par l'accompagnement des débutants et des nageurs intermédiaire. Mes séances en piscine et en extérieur sont adaptées à chaque niveau, avec un focus sur la confiance dans l'eau.",
    yearsExperience: 5,
  ...
  },
  {
    ...
    bio: "Entraîneur diplômé d'état avec 12 ans d'expérience, j'ai préparé des nageurs du niveau régional au national. Spécialisé en papillon et brasse, j'aide les nageurs avancés à franchir un cap technique et à optimiser leur rendement dans l'eau.",
    yearsExperience: 12,
  ...
  },
  {
    ...
    bio: "Ancienne maître-nageuse en piscine municipale, je privilégie une approche progressive et bienveillante. J'enseigne aux adultes comme aux enfants, du premier contact avec l'eau jusqu'au perfectionnement technique.",
    yearsExperience: 6,
  ...
  },
  {
    ...
    bio: "Préparateur physique et entraîneur de compétition depuis 12 ans, j'accompagne des nageurs ambitieux vers leurs objectifs chronométriques. Approche analytique combinée à un suivi personnalisé entre les séances.",
    yearsExperience: 12,
  ...
  },
  {
    ...
    bio: "Spécialisée dans l'apprentissage des débutants et la gestion de la peur de l'eau, j'accompagne adultes et enfants vers une nage autonome et sereine, à leur rythme.",
    yearsExperience: 4,
  ...
  },
  {
    ...
    bio: "Triathlète et coach eau libre, je prépare mes nageurs aux défis en mer et en lac : technique de nage en milieu naturel, gestion du stress, sécurité. Sessions piscine et plein air selon la saison.",
    yearsExperience: 9,
    availability: ["tue", "thu", "sat", "sun"],
    languages: ["es", "fr", "en"],
    reviewsList: [
  ...
  },
  {
    ...
    bio: "Ancienne nageuse de niveau national au Japon, j'enseigne le papillon et les nages techniques avec une exigence bienveillante. Pour nageurs intermédiaires souhaitant franchir un cap technique.",
    yearsExperience: 15,
    availability: ["mon", "tue", "thu", "fri"],
    languages: ["ja", "en", "fr"],
    reviewsList: [
  ...
  },
  {
    ...
    bio: "Jeune monitrice diplômée, passionnée par la transmission. J'enseigne aux enfants et aux adultes débutants dans une atmosphère détendue et encourageante.",
    yearsExperience: 3,
  ...
  },
  {
    ...
    bio: "Entraîneur certifié niveau régional, je coach des nageurs compétiteurs et des triathlètes confirmés. Préparation physique spécifique, analyse vidéo, programmation annuelle.",
    yearsExperience: 10,
    availability: ["mon", "wed", "fri", "sat"],
    languages: ["fr", "en", "it"],
    reviewsList: [
      { id: "r1", reviewerName: "Maxime L.", rating: 5, date: "2024-05-28", text: "Antoine m'a aidé à décrocher ma qualification pour les campeonatos de France. Sa vision stratégique de la course est remarquable." },
